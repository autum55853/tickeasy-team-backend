...
| 8 | 拆分 concert.ts（45KB） | 維護 | 🟢 低 | ✅ 完成（2026-07-17；拆為 controllers/concert/ 六檔 + barrel，routes 不動） |
| 9 | console.log 收斂為 logger | 維護 | 🟢 低 | ✅ 完成（2026-07-18；controllers/services/scheduler 全數收斂，營運訊號改 console.info/warn，敏感輸出移除） |
