...
{
  "permissions": {
    "allow": ["Edit(~/.npm/**)", "Read(~/.npm/**)", "Write(~/Library/pnpm/**)", "Edit(~/Library/pnpm/**)", "Read(~/Library/pnpm/**)"],
  ...
  "sandbox": {
    ...
    "network": {
      ...
      "allowedDomains": ["registry.npmjs.org", "*.npmjs.org", "registry.yarnpkg.com", "*.github.com", "github.com", "*.githubusercontent.com", "localhost:*"]
    }
  }
}
```
...
```json
{
  ...
  "sandbox": {
    ...
    "network": {
      "allowLocalBinding": true,
      "allowedDomains": ["pypi.org", "*.pypi.org", "files.pythonhosted.org", "*.github.com", "github.com", "*.githubusercontent.com", "localhost:*"]
    }
  }
}
```
